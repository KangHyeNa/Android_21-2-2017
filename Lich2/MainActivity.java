package com.example.enter.lich;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView txtvthangso = (TextView) findViewById(R.id.thangso);
        final TextView txtvthu = (TextView) findViewById(R.id.thu);
        final TextView txtvthungay = (TextView) findViewById(R.id.thungay);
        final TextView txtvnam = (TextView) findViewById(R.id.nam);
        final TextView txtvnamso = (TextView) findViewById(R.id.namso);
        final TextView txtvghichu = (TextView) findViewById(R.id.ghichu);
        ...
        Button luu = (Button) findViewById(R.id.luu);
        ...
        tim.setOnClickListener(new View.OnClickListener() {
                                   ...
                                   public void onClick(View view) {
                                           ...
                                           if (so1 == 1 && so2 == 1) {
                                               ...
                                               thangamlich = 12;
                                               i = -1;
                                               txtvthang.setText("THÁNG");
                                               txtvthangso.setText(thang.toString());
                                               txtvthu.setText("CHỦ NHẬT");
                                               txtvthungay.setText(ngay.toString());
                                               txtvnam.setText("NĂM");
                                               txtvnamso.setText(nam.toString());
                                               imageView.setImageResource(R.drawable.i1);
                                               txtvghichu.setText("NOTE");
                                               ...
                                               txtvthang.setText("THÁNG");
                                               txtvthangso.setText(so1.toString());
        ...
        truoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(page==1||page==0)
                {
                    ...
                    i=-1;
                    txtvthang.setText("THÁNG");
                    txtvthangso.setText("1");
                    txtvthu.setText("CHỦ NHẬT");
                    txtvthungay.setText("1");
                    txtvnam.setText("NĂM");
                    txtvnamso.setText(nam.toString());
                    imageView.setImageResource(R.drawable.i1);
                    txtvghichu.setText("NOTE");
        ...
        sau.setOnClickListener(new View.OnClickListener() {
                                   ...
                                   public void onClick(View view) {
                                       ...
                                       if (page == 364)
                                       {
                                           nam=2017;
                                           txtvthang.setText("THÁNG");
                                           txtvthangso.setText("12");
                                           txtvthu.setText("CHỦ NHẬT");
                                           txtvthungay.setText("31");
                                           txtvnam.setText("NĂM");
                                           txtvnamso.setText(nam.toString());
